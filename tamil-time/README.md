...
| **Nazhigai** | Soft steps **index** 0–9 within Siru (~24 min); UI **ordinal** 1–10 via `nazhigai_ordinal` |
...
fn main() {
    ...
    // Running Nazhigai 1 (first 24 minutes of this Siru) · mudhu venil
}
```
...
- Display ordinals: `nazhigai_ordinal`, `nazhigai_running_copy` (1-based UI copy)
