...
தொழுகைய இமையவரும் அறம்மருவு துதிசெய்தெழு துடித புரமே!`,
  [ELUCIR_KAZHINEDILADI_ACIRIYA_VIRUTHAM]: `தோடார் இலங்கு மலர்கோதி வண்டு வரிபாட நீடு துணர்சேர்
...
function variationRow(key) {
  ...
  // Trim accidental leading/trailing whitespace from template literals; internal stanza breaks stay.
  const example = String(poemVariationExamples[key]).trim();
  return { en: key, ta, example };
}
