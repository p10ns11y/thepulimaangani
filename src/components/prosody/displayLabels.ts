...
const footTypeMap: Record<string, string> = {
  ...
  'Ner-Nirai-Ner': 'கூவிளங்காய் (koovilangkaay)',
  'Ner-Nirai-Nirai': 'கூவிளங்கனி (koovilangkani)',
  ...
  'Ner-Nirai-Ner-Ner': 'கூவிளந்தண்பூ (koovilanthanpuu)',
  'Ner-Nirai-Ner-Nirai': 'கூவிளந்தண்ணிழல் (koovilanthannizhal)',
  'Ner-Nirai-Nirai-Ner': 'கூவிளநறும்பூ (koovilanarumpuu)',
  'Ner-Nirai-Nirai-Nirai': 'கூவிளநறுநிழல் (koovilanarunizhal)',
