...
|---|---:|---:|---:|---|---|
| `src/metre/prediction.rs::detect_metre_hypotheses` | 3 | 3 | 9 | critical | Heuristic metre head + linkage priors still rough on some curated fixtures; hypotheses are a staging area for richer rules / small models. _(Revisit when classical constraints land.)_ |
...
| 2026-04-30 | Rust `presentation.rs` restored; **`ParseResult.presentation`** in WASM JSON; web adapter prefers it for metre / foot / தளை display. |
