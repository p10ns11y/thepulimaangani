//! Fit hybrid metre logit on `special_type` rows from `data/poem_variations.js` and write
...
fn emit_rust(
    ...
    let mut s = String::from(
        "// Generated by `cargo run --example fit_metre_hybrid_weights` — do not hand-edit.\n",
    );
