...
**Metre boost:** [`src/metre/prediction.rs`](src/metre/prediction.rs) `boost_metre_hypotheses_with_dense` uses indices **12–18** (linkage type) and **22–26** (linkage special) only.
